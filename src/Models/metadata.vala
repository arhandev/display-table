...
public class DisplayTable.Metadata: GLib.Object{
    public Map<string, DisplayTable.KeyMetadata> heading = new HashMap<string, DisplayTable.KeyMetadata>();
...
public class DisplayTable.KeyMetadata: GLib.Object{
